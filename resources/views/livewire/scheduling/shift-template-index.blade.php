<div>
    <x-page-shell title="Shift Templates" description="Reusable scheduling patterns across sites.">
        ...
        @if($showForm)
            <x-form-card title="Create shift template" class="mb-4">
                ...
                @foreach($items as $i => $item)
                    <div class="mb-2 grid gap-2 rounded-lg border p-2 sm:grid-cols-6">
                ...
                <div class="mt-3 flex gap-2">
                    ...
                    <x-button wire:click="save">Save template</x-button>
                </div>
            </x-form-card>
        @endif

        <x-form-card title="Apply template to week">
